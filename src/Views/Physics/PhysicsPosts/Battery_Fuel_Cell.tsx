    ...
    <>
      <div className="flex justify-center m-2">
        <div className="w-full sm:w-2/3 md:w-2/3 lg:max-w-4xl xl:max-w-5xl mx-4">
          ...
          <div className="mt-1 flex break-keep"> Energy equivalent of the H2 production: <div className="font-bold px-1">0.2 Gtoe/year</div></div>
          <div className="mt-1 flex break-keep"> For oil: <div className="font-bold px-1">4.4 Gt/year</div></div>
          <div className="mt-1 flex break-keep"> World primary energy consumption: <div className="font-bold px-1">14,5 Gtoe/year</div></div>
          <div className="mt-1 flex break-keep"> % of hydrogen produced by reforming of fossil fuel: <div className="font-bold px-1">95 %</div></div>
          <div className="mt-1 flex break-keep">Fossil fuels reforming and gasification:  <div className="font-bold px-1">1 GtCO2/year</div></div>
          <div className="mt-1 flex break-keep">Human CO2 emissions:  <div className="font-bold px-1">35-40 GtCO2/year</div></div>
          ...
          <div className="font-bold text-l ">Pros and cons</div>
          - Pros
          <ul className="list-disc ml-6">
            ...
            <li>No direct greenhouse effect, but interacts with other molecules which can lead to increase of green house effect.</li>
          </ul>
          - Cons
          <ul className="list-disc ml-6">
            <li > Costs </li>
          ...
          <div className="font-bold text-xl mt-3 mb-3 underline">Converting Hydrogen to energy: </div>
          <ul className="list-disc ml-6">
          ...
          <div className="mt-1 flex"> Production's costs of hydrogen (DOE 2013): </div>
          <ul className="list-disc ml-6">
            <li >Large scale SMR: <div className="font-bold"> 1.5$/kg </div></li>
            <li>Small scale SMR: <div className="font-bold">3-6$/kg</div></li>
            <li>Electrolysis:<div className="font-bold">6-15$/kg</div> </li>
            <li>Carriage costs: <div className="font-bold">1.25$/kg</div></li>
