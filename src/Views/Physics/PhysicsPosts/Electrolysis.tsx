            ...
            <div className="flex justify-center m-2">
                <div className="w-full sm:w-2/3 md:w-1/2 lg:max-w-4xl xl:max-w-5xl mx-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-4">
                        <div className="start-col-1 end-col-2 ">
                            <div className="">
                                <Title2 text="What does it look like?" mt={0} />
                                I originally got inspired by this video (you can click on it):
                                <a href="https://youtu.be/zrnLRDMs94c?si=dSoyjsgjuIQ9-yBy">
                                    <img src={diy} className="border-4 border-black rounded" width="200" alt="Image" />
                                </a>
                            </div>
                            <div className="mt-6">
                                And I came up with this design:
                                <img src={model2} className="border-4 border-black rounded" width="200" alt="Image" />
                                "The Elephant"
                            </div>
                        ...
                        <div className="start-col-2 end-col-3">
