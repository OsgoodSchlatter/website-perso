...
export const Ingredient = ({
  ...
  return (
    <div className="justify-center border p-1 mt-1 rounded">
      <div
        className="p-2 mt-2 rounded border-transparent px-4 py-2 font-medium  -900 items-center border-2 border-slate-200"
        id={ingr.id}
      >
        <div className="grid grid-cols-8 gap-2 items-center justify-between">
          <div className="text-3xl font-semibold  col-start-1 col-end-3 cold-span-2">{ingr.name} </div>
          ...
          <div className="col-start-8 col-end-9 cold-span-1">
            <Button
              ...
              className="rounded-md bg-green-700 hover:bg-green-700 ml-2 "
